...
def main():
    ...
    required_args.add_argument(
        "-pathDataset", type=str, nargs=1, help="", required=True
    )
    required_args.add_argument(
        "-pathKeyphrases", type=str, nargs=1, help="", required=True
    )
    parser.add_argument(
        "-dataset_name", type=str, nargs=1, help="Dataset name.", required=True
    )
    parser.add_argument(
        "-pathOutput", type=str, nargs=1, help="Output path.", required=True
    )
    parser.add_argument(
        "-algorithmName", type=str, nargs=1, help="algorithm.", required=True
    )
    parser.add_argument(
        "-EvaluationStemming", type=bool, nargs="?", help="Filter method."
    )
