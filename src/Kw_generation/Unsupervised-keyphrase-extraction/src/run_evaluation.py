    ...
    for algorithm in ListOfAlgorithms:
        ...
        for i in range(len(ListOfDatasets)):
            ...
            if algorithm == "YAKE":
                ...
                CoTagRanks2v_object = CoTagRanks2v(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
                ...
                EmbedRankSentenceUSE_object = EmbedRankSentenceUSE(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
                ...
                ConceptRankUSE_object = CoTagRankUSE(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
                ...
                print("pathData", pathData)
                TopicCSRank_object = TopicCSRank(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
                ...
                print("pathData", pathData)
                TopicCSRankLDA_object = TopicCSRankLDA(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
                ...
                print("pathData", pathData)
                ConceptRankWindow_object = CoTagRankWindow(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
                ...
                print("pathData", pathData)
                CoTagRankPositional_object = CoTagRankPositional(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
                ...
                print("pathData", pathData)
                CoTagRankSentenceUSE_object = CoTagRankSentenceUSE(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
                ...
                print("pathData", pathData)
                WordAttractionRank_object = WordAttractionRank(
                    numOfKeyphrases, pathData, dataset_name, normalization
                )
...
if __name__ == "__main__":
    ...
    ListOfDatasets = ["EmJacc"]
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--expand", help="expand extracted concepts (works only with cotagrank)"
    )
    ...
    measures = ["P.10", "recall.10", "F1.10"]

    formatOutput = (
        "df"  # options: 'csv', 'html', 'json', 'latex', 'sql', 'string', 'df'
    )
    # ------------------------------------------------------------------------------------------------------------------
