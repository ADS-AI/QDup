        ...
        try:
            ...
            if expand:
                keywords, relevance, color_map = self.model.run(
                    doc_text, expand=expand, method="EmbedRank"
                )
            else:
            ...
            keywords = [
                (keyword, score)
                for (keyword), score in zip(keywords, relevance)
                if keyword
            ]
        except e:
            print(e)
