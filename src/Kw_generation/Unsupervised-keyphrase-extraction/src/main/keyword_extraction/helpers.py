...
def init_keyword_extractor(config):
    ...
    if rank_config.get("class") in [
        ...
        "CoTagRankWindow",
        "CoTagRanks2v",
    ] or encoder_config.get("class") in ["EmbedRank", "EmbedRankSentenceUSE"]:
    ...
    if rank_config.get("class") == "CoTagRank":
        rank = getattr(coTagrank, rank_config.get("class"))(**rank_config.get("kwargs"))
        ...
        rank = getattr(ranks, rank_config.get("class"))(**rank_config.get("kwargs"))
